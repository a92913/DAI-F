async function displayMarkers() {
    ...
    const id = localStorage.codchild;
    // Loop que vai percorrer a informação contida em markersData 
    // para que a função createMarker possa criar os marcadores 
    const res = await fetch('http://82.155.91.47:8080/Back-end/CoordenadasChild?cod_child=' + id);
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        createMarker(latlng, nome, points, category, date);
...
function createMarker(latlng, nome, points, category, date) {
